...
The order of the blocks are set with numerical keys (`[0]=user`, `[1]=host`, etc) and the blocks themselves are configured with keys like `[host_style]="blue bold"` and `[time_format]="+%T"`.
